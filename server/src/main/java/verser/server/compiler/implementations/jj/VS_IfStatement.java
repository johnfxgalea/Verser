/* Generated By:JJTree: Do not edit this line. VS_IfStatement.java Version 4.3 */
...
public
class VS_IfStatement extends SimpleNode {
  public VS_IfStatement(int id) {
    super(id);
  }

  public VS_IfStatement(VerificationScriptGrammar p, int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=dac066192a17f661728dc30d0a387345 (do not edit this line) */

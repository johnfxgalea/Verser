/* Generated By:JJTree: Do not edit this line. VS_Type.java Version 4.3 */
...
public
class VS_Type extends SimpleNode {
  public VS_Type(int id) {
    super(id);
  }

  public VS_Type(VerificationScriptGrammar p, int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=fe795bdb5f0553a58a75c6a31689d7cf (do not edit this line) */

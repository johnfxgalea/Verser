/* Generated By:JJTree: Do not edit this line. VS_IntegerLiteral.java Version 4.3 */
...
public
class VS_IntegerLiteral extends SimpleNode {
  public VS_IntegerLiteral(int id) {
    super(id);
  }

  public VS_IntegerLiteral(VerificationScriptGrammar p, int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=44bd088aea6f42976b5426216865a7cd (do not edit this line) */
